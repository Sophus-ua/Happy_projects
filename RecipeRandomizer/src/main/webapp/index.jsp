...
<body>
    ...
    <header>
        <h1>Вітання у Рандомайзері Рецептів!</h1>
    </header>
    ...
    <section>
        ...
        <p>Рандомайзер рецептів - це веб-застосунок, створений для зручного зберігання та полегшення вибору рецептів.</p>
        <p>Ви можете легко створювати, додавати та редагувати свої улюблені рецепти.</p>
        <p>Застосунок дозволяє вам:</p>
        <ul>
            <li>Додавати та зберігати рецепти.</li>
            <li>Додавати існуючі рецепти.</li>
            <li>Випадковим чином обирати рецепт для приготування.</li>
            <li>Швидко знаходити рецепти за різними категоріями та ТЕГами.</li>
            <li>Створювати свої прикольні ТЕГи</li>
        </ul>
    </section>

    <footer>
        <p>&copy; 2023 Рандомайзер Рецептів. Усі права захищені.</p>
    </footer>
